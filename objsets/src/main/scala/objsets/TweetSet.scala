...
abstract class TweetSet {
  ...
  /**
    * This method check whether set is empty
    */
  def isEmpty(): Boolean
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def filterAcc(p: Tweet => Boolean, acc: TweetSet): TweetSet = {
    val children = left.filterAcc(p, right.filterAcc(p, acc))
  ...
  def descendingByRetweet: TweetList = {
    ...
    val remain = this.remove(mostRetweetedTweet)
    new Cons(mostRetweetedTweet, remain.descendingByRetweet)
  }
